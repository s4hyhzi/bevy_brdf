...
fn main() {
    App::new()
        ...
        .add_plugins((DefaultPlugins, ToonShaderPlugin, AtmospherePlugin))
...
fn setup(
    ...
    commands.spawn((
        ...
        toon_materials.add(Color::SILVER.into()),
    ));
}
...
fn update_materials(
    ...
    spheres: Query<(Entity, &Handle<StandardMaterial>)>,
) {
    for sphere in spheres.iter() {
        let (entity, material) = sphere;
        match material.path() {
            Some(path) => {
